# Contributing to Sheets Dashboard Repair

Sheets Dashboard Repair is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A spreadsheet dashboard repair demo with formula health, source-row checks, chart cleanup, and handoff notes.
